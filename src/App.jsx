...
import { useSupabase } from "./hooks/useSupabase"; // 👈 Changed from useFirebase
...
function AdminDashboard() {
    ...
    const {
        ...
        uploadPhoto,
        setSettings,
    } = useSupabase(); // 👈 Changed from useFirebase
...
function PublicMenu() {
    ...
    const navigate = useNavigate();
    const { items, settings, incrementViews } = useSupabase(); // 👈 Changed
